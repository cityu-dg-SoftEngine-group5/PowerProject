...
exports.createOpenRouterStream = createOpenRouterStream;
const openai_format_1 = require("./openai-format");
const r1_format_1 = require("./r1-format");
async function createOpenRouterStream(client, systemPrompt, messages, model, o3MiniReasoningEffort, thinkingBudgetTokens) {
